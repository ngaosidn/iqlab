            ...
            <View style={styles.headerWrapper}>
              ...
              >
                ...
                <Animated.View style={[
                  ...
                  { width: 150, height: '180%', top: '-40%', transform: [{ translateX }, { rotate: '30deg' }] }
                ]}>
                    <LinearGradient
                ...
                <View style={{ marginTop: 24 }}>
                    <Text style={styles.titleText}>Ahlan Bikum! 👋</Text>
                    <Text style={styles.subtitleText}>Mau baca dan tadabbur ayat apa hari ini? ✨</Text>
                </View>
              </LinearGradient>
            </View>
...
const styles = StyleSheet.create({
  ...
  headerGradient: { padding: 24, paddingBottom: 32, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, overflow: 'hidden', elevation: 8 },
  ...
  titleText: { color: '#ffffff', fontSize: 20, fontWeight: 'bold', marginBottom: 8 },
  subtitleText: { color: 'rgba(255, 255, 255, 0.7)', fontSize: 14, fontWeight: '600' },
